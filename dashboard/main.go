...
import (
	...
	"github.com/adrianmb0/GetTheJob/dashboard/internal/data"
	"github.com/adrianmb0/GetTheJob/dashboard/internal/model"
	"github.com/adrianmb0/GetTheJob/dashboard/internal/theme"
	"github.com/adrianmb0/GetTheJob/dashboard/internal/ui/screens"
)
...
func main() {
	pathFlag := flag.String("path", ".", "Path to GetTheJob directory")
	flag.Parse()
