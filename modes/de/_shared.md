# Geteilter Kontext -- get-the-job (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle get-the-job-Modi
     in der deutschen Variante. Bevor du get-the-job verwendest, MUSST du:
