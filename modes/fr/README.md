# get-the-job -- Modes francophones (`modes/fr/`)

Ce dossier contient les traductions francaises des principaux modes get-the-job pour les candidats qui ciblent le marche francophone (France, Belgique, Suisse romande, Luxembourg, Quebec).
