# get-the-job -- 日本語モード (`modes/ja/`)

このフォルダには、日本市場または日本語で運営される企業での求職活動を行う候補者向けに、get-the-job の主要モードを日本語に翻訳したファイルが含まれています。
...
get-the-job にはコード上の「言語スイッチ」フラグはありません。代わりに 2 つの方法があります：
