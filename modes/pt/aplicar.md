...
5. **get-the-job proof point**: Incluir em "Informações adicionais" se houver campo para isso
...
3. Sugerir próximo passo: `/get-the-job contacto` para LinkedIn outreach
