# get-the-job -- Modos em Português BR (`modes/pt/`)

Esta pasta contém as traduções em português brasileiro dos principais modos do get-the-job para candidatos que buscam vagas no mercado brasileiro ou em empresas que operam em português.
...
O get-the-job não tem um "switch de idioma" como flag de código. Em vez disso, existem dois caminhos:
