# GetTheJob — AI Job Search Pipeline (Gemini CLI)
...
|---------|------------------------|-------------|
| `/get-the-job` | `/get-the-job` | Show menu or evaluate JD |
...
| `/get-the-job-contact` | `/get-the-job contacto` | LinkedIn outreach |
| `/get-the-job-deep` | `/get-the-job deep` | Deep company research |
| `/get-the-job-pdf` | `/get-the-job pdf` | Generate ATS-optimized CV |
| `/get-the-job-training` | `/get-the-job training` | Evaluate course/cert |
| `/get-the-job-project` | `/get-the-job project` | Evaluate portfolio project |
...
| `/get-the-job-batch` | `/get-the-job batch` | Batch processing |
| `/get-the-job-patterns` | `/get-the-job patterns` | Analyze rejection patterns |
