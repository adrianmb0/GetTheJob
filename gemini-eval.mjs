#!/usr/bin/env node
/**
 * gemini-eval.mjs — Gemini-powered Job Offer Evaluator for get-the-job
 *
...
const PATHS = {
  ...
  evaluate: join(ROOT, '.claude', 'skills', 'get-the-job', 'SKILL.md'),
  cv:       join(ROOT, 'cv.md'),
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           get-the-job — Gemini Evaluator (free-tier)             ║
╚══════════════════════════════════════════════════════════════════╝
...
// ---------------------------------------------------------------------------
const systemPrompt = `You are get-the-job, an AI-powered job search assistant.
